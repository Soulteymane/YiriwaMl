...
import 'package:yiriwa/widgets/comment_card.dart';
...
class CommentsScreen extends StatefulWidget {
  ...
  const CommentsScreen(
      {Key? key, required this.postId, this.snap, required this.uid})
      : super(key: key);
      ...
      bottomNavigationBar: SafeArea(
        child: Container(
          ...
          child: Row(
            children: [
              CircleAvatar(
                backgroundImage: NetworkImage(widget.snap['photo'].toString()),
                radius: 18,
              ),
              Expanded(
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Commenter en tant que ',
